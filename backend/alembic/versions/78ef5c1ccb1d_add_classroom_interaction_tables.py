...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_znt_classroom_activities_id'), 'znt_classroom_activities', ['id'])
    op.create_index('ix_znt_classroom_activities_created_by', 'znt_classroom_activities', ['created_by'])
    ...
    op.create_index(op.f('ix_znt_classroom_responses_id'), 'znt_classroom_responses', ['id'])
    op.create_index('ix_znt_classroom_responses_activity_id', 'znt_classroom_responses', ['activity_id'])
    op.create_index('ix_znt_classroom_responses_user_id', 'znt_classroom_responses', ['user_id'])

...
def upgrade() -> None:
    ...
    # Check columns
    courses_cols = [c['name'] for c in inspector.get_columns('xbk_courses')]
    if 'grade' not in courses_cols:
    ...
    selections_cols = [c['name'] for c in inspector.get_columns('xbk_selections')]
    if 'grade' not in selections_cols:
    ...
    students_cols = [c['name'] for c in inspector.get_columns('xbk_students')]
    if 'grade' not in students_cols:

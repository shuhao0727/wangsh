...
from app.api.pythonlab.compat_routes import router as compat_router
...
# /api/v1/debug remains a deprecated compatibility alias.
...
router.include_router(compat_router, tags=["pythonlab-v2"])

...
class GroupDiscussionSession(Base):
    ...
    created_by_user_id = Column(Integer, ForeignKey("sys_users.id", ondelete="SET NULL"), nullable=True, index=True)
...
class GroupDiscussionAnalysis(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    session_id = Column(Integer, ForeignKey("znt_group_discussion_sessions.id", ondelete="CASCADE"), nullable=False, index=True)
    agent_id = Column(Integer, ForeignKey("znt_agents.id", ondelete="CASCADE"), nullable=False, index=True)
    created_by_admin_user_id = Column(Integer, ForeignKey("sys_users.id", ondelete="CASCADE"), nullable=False, index=True)

...
| 清理项 | 当前状态 |
|--------|----------|
| pub/sub 提取到 `app/core/pubsub.py` | **已完成 v1.5.3** |
| celery_app 合并 | **已完成 v1.5.3** |
| database.py 死代码移除 | **已完成 v1.5.3** |
| deps.py 清理 | **已完成 v1.5.3** |
| classroom.py 拆分 | **部分完成** — 仍 581 行 |
| xbk/data.py 拆分 (645行) | **未开始** |
| debug/flow.py 拆分 (1277行) | **未开始** |
| CSS 文件清理 | **部分完成** — 8 个文件仍存在 |
